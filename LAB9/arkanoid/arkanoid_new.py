...
settings = pygame.image.load('set.png').convert_alpha()
exitt = pygame.image.load('exit.png').convert_alpha()
background_image = pygame.image.load('cats3.jpg').convert_alpha()
...
start_button = Button(450, 250, play)
setting_button = Button(450, 350, settings) 
exit_button = Button(450, 450, exitt) 
...
while run:
    ...
    text_rect = text.get_rect(center=(580, 150))
        ...
        if event.type == pygame.QUIT:
            ...
            if start_button.is_clicked(pygame.mouse.get_pos()):
                ...
                while True:
                    ...
                    pygame.display.flip()
            elif setting_button.is_clicked(pygame.mouse.get_pos()):
