...
class Coin(pygame.sprite.Sprite):
    ...
    def spawn(self):
        ...
        self.rect.centery = 520 # Фиксированная координата y на 550 пикселей
...
pygame.time.set_timer(SPAWN_COIN, 5000)  # Создаем новую монету каждые 5 секунд
...
while True:
    for event in pygame.event.get():
        ...
        if event.type == SPAWN_COIN:
            new_coin = Coin()
            new_coin.spawn()  # Вызываем метод spawn для установки начальной позиции
            coins.add(new_coin)
